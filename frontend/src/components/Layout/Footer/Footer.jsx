    ...
    <div className="bg-[#000] text-white">
      <div className="md:flex md:justify-between md:items-start sm:px-12 px-4 bg-[#342ac8] py-7">
        ...
        <div>
          <input
            ...
            className="text-gray-100 sm:w-72  w-full sm:mr-5 mr-1 lg:mb-0 mb-4 py-2.5 rounded px-2 focus:outline-none"
          />
      ...
      <div className="grid grid-cols-1  sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-5 py-16 sm:text-center">
        <ul className="px-5 text-center sm:text-start flex sm:block flex-col items-center">
          ...
          <p>The home and elements needeed to create beautifull products</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center pt-2 text-gray-400 text-sm pb-8">
        <span>2025 Marion . All rights reserve, </span>
        <span>Terms . Privacy Policy</span>
        <div className="sm:block flex items-center justify-center w-full m-auto">
          <img
